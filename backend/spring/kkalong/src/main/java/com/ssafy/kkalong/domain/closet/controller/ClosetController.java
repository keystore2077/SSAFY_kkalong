...
import com.ssafy.kkalong.domain.fastapi.Service.FastApiService;
...
public class ClosetController {
    ...
    public Api<Object> putCloset(@RequestParam(required = false) MultipartFile file,
            @ModelAttribute ClosetUpdateRequest closetUpdateRequest) {
